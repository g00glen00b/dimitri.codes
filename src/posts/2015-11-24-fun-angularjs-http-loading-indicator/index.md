...
Testing it out might be a bit difficult if you have a fast network connection. However, The Chrome DevTools allow you to throttle network requests, making it easier to test these features. [![chrome-throttle](images/chrome-throttle.png)](https://wordpress.g00glen00b.be/wp-content/uploads/2015/10/chrome-throttle.png)
...
[![if-loading-demo](images/if-loading-demo.png)](https://wordpress.g00glen00b.be/wp-content/uploads/2015/10/if-loading-demo.png)
