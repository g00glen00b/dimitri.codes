...
In [my previous tutorial](http://wordpress.g00glen00b.be/unit-testing-meteor-applications-with-velocity-jasmine-and-sinon-js/) I mentioned how to write unit tests for Meteor using Jasmine and Sinon.js on the Velocity platform.
...
[![header](images/header.png)](https://wordpress.g00glen00b.be/wp-content/uploads/2015/08/header.png)
...
this.When(/^I visit the application$/, function(callback) {
  this.client.url(process.env.ROOT\_URL).call(callback);
});
...
this.Given(/^a user exists with the name \\"(.+)\\"$/, function(name, callback) {
  this.server.call('testUser', name, DEFAULT\_PASSWORD, callback);
});
...
this.When(/^I log in as \\"(.+)\\"$/, function(name, callback) {
  this.client
    ...
    .waitForVisible('#login-dropdown-list')
      ...
      .setValue('#login-password', DEFAULT\_PASSWORD)
...
var DEFAULT\_PASSWORD = 'p4ssw0rd';
...
[![velocity-results](images/velocity-results-300x149.png)](https://wordpress.g00glen00b.be/wp-content/uploads/2015/08/velocity-results.png)
...
[![cucumber-results](images/cucumber-results-261x300.png)](https://wordpress.g00glen00b.be/wp-content/uploads/2015/08/cucumber-results.png)
