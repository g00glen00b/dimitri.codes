...
As youcan see we're passing several things to it, we pass the score (`score`), the maximum score (`max`), the action that should be executed when the score is changed (`updateScore`) and the parameter that we're going to pass to that function (`param`). All of these are custom parameters which we are going to use later on in our implementation.
...
[![app-component](images/app-component-1024x216.png)](http://wordpress.g00glen00b.be/ember-components-views/app-component/)
...
[![app-stars](images/app-stars-1024x215.png)](http://wordpress.g00glen00b.be/ember-components-views/app-stars/)
...
[![app-stars-3](images/app-stars-3-1024x231.png)](http://wordpress.g00glen00b.be/ember-components-views/app-stars-3/)
...
[![app-score-update](images/app-score-update-1024x228.png)](http://wordpress.g00glen00b.be/ember-components-views/app-score-update/)
...
[![app-sort-before](images/app-sort-before-1024x272.png)](http://wordpress.g00glen00b.be/ember-components-views/app-sort-before/)

And after changing the score of the second song we get:

[![app-sort](images/app-sort-1024x262.png)](http://wordpress.g00glen00b.be/ember-components-views/app-sort/)
...
[![app-no-highlight](images/app-no-highlight-1024x287.png)](http://wordpress.g00glen00b.be/ember-components-views/app-no-highlight/)

The moment we hover over a specific star, the highlighting class will take over:

[![app-highlight](images/app-highlight-1024x276.png)](http://wordpress.g00glen00b.be/ember-components-views/app-highlight/)
